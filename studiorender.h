...
{
public:
	__forceinline void set_float_value(float val) {
		util::get_method< void(__thiscall *)(void *, float) >(this, 4)(this, val);
	}
	__forceinline void set_int_value(int val) {
		util::get_method< void(__thiscall *)(void *, int) >(this, 5)(this, val);
	}

	__forceinline void set_vec_value(float x, float y, float z) {
		util::get_method< void(__thiscall *)(void *, float, float, float) >(this, 11)(this, x, y, z);
	}
};
...
public:
	...
	__forceinline IMaterialVar* FindVar(const char *varName, bool *found, bool complain = true)
	{
